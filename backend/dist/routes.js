...
const CreaterUserController_1 = require("./controllers/user/CreaterUserController");
const AuthUserController_1 = require("./controllers/user/AuthUserController");
const DetailUserController_1 = require("./controllers/user/DetailUserController");
const isAuthenticated_1 = require("./middlewares/isAuthenticated");
const CreateCategoryController_1 = require("./controllers/category/CreateCategoryController");
const ListCategoryController_1 = require("./controllers/category/ListCategoryController");
const CreateProducController_1 = require("./controllers/product/CreateProducController");
...
// --> ROTAS USER <--
router.post('/users', new CreaterUserController_1.CreateUserController().handle);
...
// --> ROTAS PRODUCT <--
router.post('/product', isAuthenticated_1.isAuthenticated, upload.single('file'), new CreateProducController_1.CreateProductController().handle);
